                    ...
                    <li class="treeview <?php echo set_Topmenu('Academics'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('subject', 'can_view')) {
                             ...
                             if ($this->rbac->hasPrivilege('school', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('school/index'); ?>"><a href="<?php echo base_url(); ?>school"><i class="fa fa-angle-double-right"></i> School </a></li>
                                <?php
                            }
