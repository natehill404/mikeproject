                            ...
                            <div class="staround">
                                ...
                                <div class="cardright">
                                    <ul class="stlist">
                                        ...
                                        <?php if ($id_card[0]->enable_class == 1) { ?><li><?php echo $this->lang->line('class'); ?><span><?php echo $student->class?></span></li><?php } ?>
                                        ...
                                        <?php if ($id_card[0]->enable_card_validity == 1) { ?><li class="stred">Expiry Date <span><?php echo $student->id_card_validity; ?></span></li><?php } ?>
                                    </ul>
                                </div><!--./cardright-->
                            </div><!--./staround-->
                        </td>
