                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" enctype="multipart/form-data" action="<?php echo site_url('admin/studentidcard/edit/') . $editidcard[0]->id ?>"  id="certificateform" name="certificateform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group switch-inline">
                                    <label>ID Card Validity</label>
                                    <div class="material-switch switchcheck">
                                    <input id="id_card_validity" name="id_card_validity" type="checkbox" class="chk" value="1" <?php echo set_checkbox('is_active_student_img', '1', (set_value('id_card_validity', $editidcard[0]->enable_card_validity) == 1) ? TRUE : FALSE); ?>>
                                    
                                        <label for="id_card_validity" class="label-success"></label>
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
