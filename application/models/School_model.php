...
class School_model extends MY_Model {
    ...
    public function remove($id) {
        ...
        //=======================Code Start===========================
        $this->db->where('id', $id);
        $this->db->delete('school_houses'); //class record delete.

        $this->db->where('id', $id);
        $this->db->delete('school_houses'); //class_sections record delete.

        $message = DELETE_RECORD_CONSTANT . " On school id " . $id;
        $action = "Delete";
        $record_id = $id;
    ...
    public function add($data) {
        if (isset($data['id'])) {
            ...
            $this->db->update('school_houses', $data);
        } else {
    ...
    public function school_exists($str) {


        $school = $this->security->xss_clean($str);
        $res = $this->check_data_exists($school);
