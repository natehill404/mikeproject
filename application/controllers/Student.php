  ...
  $data['exam_result']          = $this->examgroupstudent_model->searchStudentExams($student['student_session_id'], true, true);
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $id_card_validity            = $this->input->post('id_card_validity');
            ...
            if (isset($id_card_validity)) {
                
                $data_insert['id_card_validity'] = $this->input->post('id_card_validity');
            }
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (isset($id_card_validity)) {
                ...
                $data['id_card_validity'] = $this->input->post('id_card_validity');
            }
